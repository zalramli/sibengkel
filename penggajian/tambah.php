  ...
  if (isset($_POST['kode_barang'])) {
    ...
    if ($query) {
      ...
      if ($query_detail) {
        ...
        echo "<script>alert('Terjadi Kesalahan Input Database'); window.location = 'admin.php?halaman=add_permintaan_barang'</script>";
      }
    } else {
      echo "<script>alert('Terjadi Kesalahan Input Database'); window.location = 'admin.php?halaman=add_permintaan_barang'</script>";
    }
  } else {
    echo "<script>alert('Gagal Mengirim Data , data detail harus ada !'); window.location = 'admin.php?halaman=add_permintaan_barang'</script>";
  }
}
?>
