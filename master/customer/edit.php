  ...
  <form action="" method="post">
      ...
      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
        ...
        <div class="form-group">
          <div class="nk-int-st">
            ...
            <input type="text" pattern="[A-Za-z\s]+" name="nama_customer" class="form-control" placeholder="Isi form nama customer" required="" maxlength="50" oninvalid="this.setCustomValidity('Nama Wajib Diisi & Tidak Boleh Angka')" value="<?= $data['nama_customer'] ?>" oninput="setCustomValidity('')">
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="row">
      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
        ...
        <div class="form-group">
          <div class="nk-int-st">
            <input type="text" name="no_telp" onkeypress="return hanyaAngka(event)" class="form-control" placeholder="Isi form No telp" required="" maxlength="20" oninvalid="this.setCustomValidity('Nomor Telephone Wajib Diisi & Harus Angka')" oninput="setCustomValidity('')" value="<?= $data['no_telp'] ?>">
          </div>
        </div>
      </div>
    </div>
