...
<div class="form-element-list">
    ...
    <div class="row">
        ...
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
            <label for="">Kode Jenis Pegawai</label>
            <div class="form-group">
                <div class="nk-int-st">
                    <input type="text" name="kode_jenis_p" class="form-control" placeholder="Isi form nama jenis pegawai" readonly="" value="<?= $data['kode_jenis_p'] ?>">
                </div>
            </div>
        </div>
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
