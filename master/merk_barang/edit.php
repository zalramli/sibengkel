            ...
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                ...
                <div class="form-group">
                    <div class="nk-int-st">
                        ...
                        <input type="text" name="nama_merk" class="form-control" placeholder="Isi form nama Merk barang" required="" maxlength="30" oninvalid="this.setCustomValidity('Nama Merk Barang Wajib Diisi')" oninput="setCustomValidity('')" value="<?= $data['nama_merk'] ?>">
                    </div>
                </div>
            </div>
        </div>
